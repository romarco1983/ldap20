...
La imatge pot funcionar en mode detach i interactiu. S'executa amb la següent comanda:
    ...
    detach:     docker run --rm --name ldap.edt.org -h ldap.edt.org --net 2hisix -p 389:389 -d isx43457566/ldap20:group
    
    interactiu: docker run --rm --name ldap.edt.org -h ldap.edt.org --net 2hisix -p 389:389 -it isx43457566/ldap20:group /bin/bash
